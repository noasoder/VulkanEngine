...
TextureManager::~TextureManager()
{
    ...
    vkDestroyImage(*pDevice, m_textureImage, nullptr);
    vkFreeMemory(*pDevice, m_textureImageMemory, nullptr);
}
                                    ...
                                    VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
{
    ...
    vkBindImageMemory(*pDevice, image, imageMemory, 0);
}
...
void TextureManager::CreateTextureSampler() 
{
    ...
    if (vkCreateSampler(*pDevice, &samplerInfo, nullptr, &m_textureSampler) != VK_SUCCESS) {
